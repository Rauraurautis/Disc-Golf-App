        ...
        <View style={styles.container}>
            ...
            >
                ...
                {courses.map((course, i) => {
                    return <Marker onPress={() => handleMarkerPress(course)} coordinate={course.coordinates} key={i} title={course.name} description={`Holes: ${Object.keys(course.holes).length}`}>
